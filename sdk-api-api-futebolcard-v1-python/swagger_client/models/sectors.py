...
class Sectors(object):
    ...
    def __init__(self, gates=None, map=None):
        """
        Sectors - a model defined in Swagger
    ...
    def gates(self):
        """
        Gets the gates of this Sectors.

        :return: The gates of this Sectors.
    ...
    def gates(self, gates):
        """
        Sets the gates of this Sectors.

        :param gates: The gates of this Sectors.
