...
class StatusCartaoResponse(object):
    ...
    def status(self):
        """
        Gets the status of this StatusCartaoResponse.
        Status relacionado a um cartão (Bloqueado, DesbloqueadoReativo ou Cancelado)

        :return: The status of this StatusCartaoResponse.
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """
        Sets the status of this StatusCartaoResponse.
        Status relacionado a um cartão (Bloqueado, DesbloqueadoReativo ou Cancelado)

        :param status: The status of this StatusCartaoResponse.
        :type: str
        """
