...
public class Events {
  ...
  public boolean equals(Object o) {
    ...
    return (this.objectCode == null ? events.objectCode == null : this.objectCode.equals(events.objectCode)) &&
        (this.eventType == null ? events.eventType == null : this.eventType.equals(events.eventType)) &&
        (this.eventStatus == null ? events.eventStatus == null : this.eventStatus.equals(events.eventStatus)) &&
        (this.eventDescription == null ? events.eventDescription == null : this.eventDescription.equals(events.eventDescription)) &&
        (this.unitName == null ? events.unitName == null : this.unitName.equals(events.unitName)) &&
        (this.sROCode == null ? events.sROCode == null : this.sROCode.equals(events.sROCode)) &&
        (this.county == null ? events.county == null : this.county.equals(events.county)) &&
        (this.state == null ? events.state == null : this.state.equals(events.state)) &&
        (this.mCUCode == null ? events.mCUCode == null : this.mCUCode.equals(events.mCUCode)) &&
        (this.dRCode == null ? events.dRCode == null : this.dRCode.equals(events.dRCode)) &&
        (this.dRAbbreviation == null ? events.dRAbbreviation == null : this.dRAbbreviation.equals(events.dRAbbreviation)) &&
        (this.listNumber == null ? events.listNumber == null : this.listNumber.equals(events.listNumber)) &&
        (this.station == null ? events.station == null : this.station.equals(events.station)) &&
        (this.user == null ? events.user == null : this.user.equals(events.user)) &&
        (this.recordingDate == null ? events.recordingDate == null : this.recordingDate.equals(events.recordingDate)) &&
        (this.deliveryman == null ? events.deliveryman == null : this.deliveryman.equals(events.deliveryman)) &&
        (this.creationDate == null ? events.creationDate == null : this.creationDate.equals(events.creationDate)) &&
        (this.blockAction == null ? events.blockAction == null : this.blockAction.equals(events.blockAction));
  }
