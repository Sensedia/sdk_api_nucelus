...
module SwaggerClient
  ...
  class NovoCartaoPortador
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'sobrenome')
        self.sobrenome = attributes[:'sobrenome']
      end

      if attributes.has_key?(:'dataNascimento')
      ...
      if attributes.has_key?(:'contato')
        self.contato = attributes[:'contato']
      end

      if attributes.has_key?(:'endereco')
    ...
    def hash
      [nome, sobrenome, data_nascimento, cpf, contato, endereco].hash
    end
