...
namespace IO.Swagger.Model
{
    ...
    public partial class InlineResponse2002 :  IEquatable<InlineResponse2002>, IValidatableObject
    {
        ...
        /// <summary>
        /// Gets or Sets Subsectors
        /// </summary>
        [DataMember(Name="subsectors", EmitDefaultValue=false)]
        public List<InlineResponse2002Subsectors> Subsectors { get; set; }
        /// <summary>
        /// Gets or Sets Map
        /// </summary>
        ...
        public bool Equals(InlineResponse2002 other)
        {
            ...
            return 
                (
                    this.Subsectors == other.Subsectors ||
                    this.Subsectors != null &&
                    this.Subsectors.SequenceEqual(other.Subsectors)
                ) && 
                (
                    this.Map == other.Map ||
                    this.Map != null &&
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Subsectors != null)
                    hash = hash * 59 + this.Subsectors.GetHashCode();
                if (this.Map != null)
