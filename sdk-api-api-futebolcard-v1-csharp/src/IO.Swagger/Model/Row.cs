...
namespace IO.Swagger.Model
{
    ...
    public partial class Row :  IEquatable<Row>, IValidatableObject
    {
        ...
        public Row(string RowId = default(string), string RowAlias = default(string), string RowName = default(string), List<EventseventIdsectorssectorIdsubsectorssubsectorIdSeats> Seats = default(List<EventseventIdsectorssectorIdsubsectorssubsectorIdSeats>))
        {
            this.RowId = RowId;
