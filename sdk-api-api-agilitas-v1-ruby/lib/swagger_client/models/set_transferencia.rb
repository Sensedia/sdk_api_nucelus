...
module SwaggerClient
  ...
  class SetTransferencia
    ...
    attr_accessor :id_cartao_destino
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'idCartao')
        self.id_cartao = attributes[:'idCartao']
      end

      if attributes.has_key?(:'idCartaoDestino')
        self.id_cartao_destino = attributes[:'idCartaoDestino']
      end

      if attributes.has_key?(:'valor')
        self.valor = attributes[:'valor']
      end

      if attributes.has_key?(:'senha')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          id_cartao_destino == o.id_cartao_destino &&
          valor == o.valor &&
          senha == o.senha
    end
    ...
    def hash
      [id_cartao, id_cartao_destino, valor, senha].hash
    end
