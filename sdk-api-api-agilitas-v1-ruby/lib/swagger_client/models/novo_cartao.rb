...
module SwaggerClient
  ...
  class NovoCartao
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'contrasenha')
        self.contrasenha = attributes[:'contrasenha']
      end

      if attributes.has_key?(:'portador')
    ...
    def hash
      [id_cartao, valor, contrasenha, portador].hash
    end
