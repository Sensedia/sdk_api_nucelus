...
module SwaggerClient
  ...
  class DetalhamentoExtrato
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dataHora')
        self.data_hora = attributes[:'dataHora']
      end

      if attributes.has_key?(:'estabelecimento')
    ...
    def hash
      [data_hora, estabelecimento, tipo, valor].hash
    end
