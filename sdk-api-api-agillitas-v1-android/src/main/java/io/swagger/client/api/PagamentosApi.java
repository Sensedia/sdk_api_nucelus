...
public class PagamentosApi {
  ...
  * &lt;p&gt;Permite o pagamento de boletos.&lt;/p&gt;
   ...
   * @return void
  */
  public void pagamentosPost (Pagamento boleto) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = boleto;
    // verify the required parameter 'boleto' is set
    if (boleto == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'boleto' when calling pagamentosPost",
        new ApiException(400, "Missing the required parameter 'boleto' when calling pagamentosPost"));
    }
   ...
   * @param boleto Objeto de requisição
  */
  public void pagamentosPost (Pagamento boleto, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = boleto;
