...
public class EventsApi {
    ...
    private com.squareup.okhttp.Call eventsEventIdGetCall(String clientId, String accessToken, String eventId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call eventsEventIdSectorsGetCall(String clientId, String accessToken, String eventId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/events/{eventId}/sectors".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "eventId" + "\\}", apiClient.escapeString(eventId.toString()));
    ...
    private com.squareup.okhttp.Call eventsEventIdSectorsSectorIdGetCall(String clientId, String accessToken, String eventId, String sectorId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/events/{eventId}/sectors/{sectorId}".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "eventId" + "\\}", apiClient.escapeString(eventId.toString()))
    ...
    private com.squareup.okhttp.Call eventsEventIdSectorsSectorIdSubsectorsGetCall(String clientId, String accessToken, String eventId, String sectorId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/events/{eventId}/sectors/{sectorId}/subsectors".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "eventId" + "\\}", apiClient.escapeString(eventId.toString()))
        .replaceAll("\\{" + "sectorId" + "\\}", apiClient.escapeString(sectorId.toString()));
    ...
    private com.squareup.okhttp.Call eventsEventIdSectorsSectorIdSubsectorsSubsectorIdGetCall(String clientId, String accessToken, String eventId, String sectorId, String subsectorId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/events/{eventId}/sectors/{sectorId}/subsectors/{subsectorId}".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "eventId" + "\\}", apiClient.escapeString(eventId.toString()))
        .replaceAll("\\{" + "sectorId" + "\\}", apiClient.escapeString(sectorId.toString()))
    ...
    private com.squareup.okhttp.Call eventsGetCall(String clientId, String accessToken, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
